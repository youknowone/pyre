...
mod tests {
    ...
    fn test_schedule_prioritizes_critical_path() {
        ...
        let mut ops = vec![
            ...
            Op::new(
                OpCode::IntMul,
                &[OpRef::int_op(0), OpRef::input_arg_int(101)],
            ), // B (idx 1, depends on A)
            Op::new(
                OpCode::IntSub,
                &[OpRef::int_op(1), OpRef::input_arg_int(101)],
            ), // C (idx 2, depends on B)
            Op::new(
                OpCode::IntAdd,
                &[OpRef::input_arg_int(102), OpRef::input_arg_int(103)],
            ), // D (idx 3, independent)
    ...
    fn test_guard_analysis_hoistable() {
        let ops = vec![
            Op::new(OpCode::GuardTrue, &[OpRef::input_arg_int(100)]), // loop-invariant (100 not produced)
            Op::new(
                OpCode::IntAdd,
                &[OpRef::input_arg_int(100), OpRef::input_arg_int(101)],
            ),
    ...
    fn test_follow_def_use_chain() {
        let mut ops = vec![
            ...
            Op::new(
                OpCode::IntSub,
                &[OpRef::int_op(1), OpRef::input_arg_int(103)],
            ), // 2: uses result of 1
            Op::new(
                OpCode::IntAdd,
                &[OpRef::input_arg_int(104), OpRef::input_arg_int(105)],
    ...
    fn test_vector_loop_from_trace() {
        let mut ops = vec![
            ...
            Op::new(OpCode::Label, &[OpRef::input_arg_int(100)]), // loop header
            Op::new(
                OpCode::IntAdd,
                &[OpRef::input_arg_int(100), OpRef::input_arg_int(101)],
            ), // body
