#![allow(
    // The optimizer is a line-by-line RPython port. Its box forwarding,
    // explicit phase arguments, enum shapes, and indexed algorithms are part
    // of that structural contract rather than Rust API design choices.
