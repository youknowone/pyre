...
pub use pyjitpl::{
    ...
    call_int_function, call_ref_function, call_void_function, cancel_observer_replay,
    consume_observed_float_call, consume_observed_getfield, consume_observed_int_call,
    consume_observed_ref_call, consume_observed_void_call, counters, in_observer_mode,
