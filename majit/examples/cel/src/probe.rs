...
/// loop.
///
/// The count is pinned exactly because this program has one hot loop. The
/// `exclusive` wrapper makes an extra compilation observable rather than
/// allowing a concurrent probe's trace to satisfy a loose lower bound.
///
