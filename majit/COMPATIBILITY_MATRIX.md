...
- Incremental GC marking is implemented (gray-stack tri-color marking with bounded steps piggybacked on minor collections); remaining gap is incremental write-barrier snapshot-at-the-beginning support for mutations during marking.
