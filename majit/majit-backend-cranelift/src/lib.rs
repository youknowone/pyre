...
pub use compiler::{
    ...
    jit_exc_value_raw, register_call_assembler_force, register_call_assembler_handle_fail,
    register_call_assembler_unbox_int, register_jitframe_layout, register_materialize_str_call,
    register_materialize_str_plain, register_pending_call_assembler_target,
    register_prologue_probe_addr, register_rebuild_state_after_failure,
