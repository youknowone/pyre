...
pub use compiler::{
    ...
    get_latest_descr_from_deadframe, get_ref_from_deadframe,
    get_savedata_ref_from_deadframe, install_gc_standalone, jit_exc_class_raw, jit_exc_clear,
    jit_exc_is_pending, jit_exc_raise, jit_exc_value_peek, jit_exc_value_raw,
    ...
    register_recovery_layout, register_resumedata_deopt, register_stack_check_addresses,
    set_gil_hooks, set_jitframe_gc_type_id, set_savedata_ref_on_deadframe,
