...
pub use compiler::{
    ...
    register_call_assembler_take_exception, register_call_assembler_unbox_int,
    register_inline_frame_arena, register_pending_call_assembler_target,
    register_rebuild_state_after_failure, set_gil_hooks, set_jitframe_gc_type_id,
