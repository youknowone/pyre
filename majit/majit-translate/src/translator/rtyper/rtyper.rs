...
impl RPythonTyper {
    ...
    pub fn translate_operation(&self, hop: &HighLevelOp) -> RTypeResult {
        match hop.spaceop.opname.as_str() {
            ...
            //     (unsimplify.rs:280, before rtyper-phase split-block
            //     calls land in the rtyper input graph),
            //   - `backendopt/constfold.rs:859`,
            //     `backendopt/all.rs:615`, `removenoops.rs:86`,
