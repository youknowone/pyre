...
pub fn generate_from_graph(
    result: &crate::translate_legacy::pipeline::ProgramPipelineResult,
) -> String {
...
mod tests {
    ...
    fn generate_from_graph_produces_function_table() {
        ...
        let pipeline = crate::translate_legacy::pipeline::analyze_program(
            &program,
            &crate::translate_legacy::pipeline::PipelineConfig::default(),
        );
    ...
    fn generate_from_pipeline_emits_canonical_header() {
        let mut pipeline = crate::translate_legacy::pipeline::ProgramPipelineResult {
            functions: Vec::new(),
            opcode_dispatch: vec![crate::translate_legacy::pipeline::PipelineOpcodeArm {
                arm_id: 0,
        ...
        pipeline
            .functions
            .push(crate::translate_legacy::pipeline::PipelineResult {
                name: "add".into(),
                original_blocks: 1,
                annotations_count: 0,
    ...
    fn generate_dispatch_tables_emits_all_tables() {
        let pipeline = crate::translate_legacy::pipeline::ProgramPipelineResult {
            functions: Vec::new(),
