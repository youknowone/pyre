...
fn build_jit_driver_pair() -> JitDriverPair {
    ...
    #[cfg(target_arch = "wasm32")]
    {
        ...
        for addr in [
            ...
            pyre_interpreter::listobject::jit_list_contains_int as *const () as usize as i64,
            ...
            crate::call_jit::bh_truth_fn as *const () as usize as i64,
            crate::call_jit::resolve_exception_context as *const () as usize as i64,
