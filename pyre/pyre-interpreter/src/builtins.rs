...
pub fn install_default_builtins(namespace: &mut PyNamespace) {
    ...
    namespace.get_or_insert_with("delattr", || w_builtin_func_new("delattr", builtin_delattr));
    ...
    namespace.get_or_insert_with("staticmethod", || {
        crate::typedef::get_builtin_type(&pyre_object::propertyobject::STATICMETHOD_TYPE)
    });
    namespace.get_or_insert_with("classmethod", || {
        crate::typedef::get_builtin_type(&pyre_object::propertyobject::CLASSMETHOD_TYPE)
    });
    ...
    namespace.get_or_insert_with("globals", || w_builtin_func_new("globals", builtin_globals));
    namespace.get_or_insert_with("locals", || w_builtin_func_new("locals", builtin_locals));
    namespace.get_or_insert_with("exec", || w_builtin_func_new("exec", |_| Ok(w_none())));
    namespace.get_or_insert_with("eval", || w_builtin_func_new("eval", |_| Ok(w_none())));
    namespace.get_or_insert_with("compile", || {
        w_builtin_func_new("compile", |_| Ok(w_none()))
    });
    namespace.get_or_insert_with("input", || {
        w_builtin_func_new("input", |_| Ok(pyre_object::w_str_new("")))
    });
    namespace.get_or_insert_with("open", || {
        w_builtin_func_new("open", |_| {
...
fn builtin_abs(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    unsafe {
        if pyre_object::is_instance(obj) {
            ...
            if let Some(method) = crate::baseobjspace::lookup_in_type_mro_pub(w_type, "__abs__") {
...
fn builtin_type_with_meta(
    ...
    if args.len() == 3 {
        ...
        let mro = unsafe { crate::baseobjspace::compute_mro_pub(w_type) };
        ...
        if !metatype.is_null() {
            let type_type_obj = crate::typedef::get_builtin_type(&pyre_object::pyobject::TYPE_TYPE);
        ...
        if unsafe { is_dict(ns_dict) } {
            ...
            for (k, v) in entries {
                if unsafe { is_str(k) } {
                    if let Ok(set_name) = crate::baseobjspace::py_getattr(v, "__set_name__") {
    ...
    if obj.is_null() {
        return Ok(crate::typedef::get_builtin_type(
...
unsafe fn is_subtype(w_type: PyObjectRef, cls: PyObjectRef) -> bool {
    ...
    crate::baseobjspace::compute_mro_pub(w_type)
        .iter()
...
fn builtin_bool(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    Ok(w_bool_from(crate::baseobjspace::py_is_true(args[0])))
}
...
fn builtin_hasattr(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    Ok(w_bool_from(
        crate::baseobjspace::py_getattr(obj, name).is_ok(),
    ))
}
...
fn builtin_getattr(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    let obj = args[0];
    let name = unsafe { w_str_get_value(args[1]) };
    match crate::baseobjspace::py_getattr(obj, name) {
        Ok(val) => Ok(val),
        Err(e) => {
            if args.len() > 2 {
...
fn builtin_setattr(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    let obj = args[0];
    let name = unsafe { w_str_get_value(args[1]) };
    let _ = crate::baseobjspace::py_setattr(obj, name, args[2]);
    Ok(w_none())
}
...
fn collect_iterable(obj: PyObjectRef) -> Result<Vec<PyObjectRef>, crate::PyError> {
    let it = crate::baseobjspace::py_iter(obj)?;
    let mut items = Vec::new();
    loop {
        match crate::baseobjspace::py_next(it) {
            Ok(v) => items.push(v),
...
pub fn builtin_set_from_items(items: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    let _ = crate::baseobjspace::py_setattr(obj, "__data__", data);
    // add()
    let _ = crate::baseobjspace::py_setattr(
        ...
        crate::w_builtin_func_new("add", |args| {
            if args.len() >= 2 {
                if let Ok(data) = crate::baseobjspace::py_getattr(args[0], "__data__") {
    ...
    let _ = crate::baseobjspace::py_setattr(
        obj,
        "pop",
        crate::w_builtin_func_new("pop", |args| {
            if !args.is_empty() {
                if let Ok(data) = crate::baseobjspace::py_getattr(args[0], "__data__") {
                    unsafe {
    ...
    let _ = crate::baseobjspace::py_setattr(
        ...
        crate::w_builtin_func_new("__iter__", |args| {
            if !args.is_empty() {
                if let Ok(data) = crate::baseobjspace::py_getattr(args[0], "__data__") {
                    return crate::baseobjspace::py_iter(data);
                }
            }
    ...
    let _ = crate::baseobjspace::py_setattr(
        ...
        crate::w_builtin_func_new("__len__", |args| {
            if !args.is_empty() {
                if let Ok(data) = crate::baseobjspace::py_getattr(args[0], "__data__") {
                    return crate::baseobjspace::py_len(data);
                }
            }
    ...
    let _ = crate::baseobjspace::py_setattr(
        obj,
        "__and__",
        crate::w_builtin_func_new("__and__", |args| {
            if args.len() < 2 {
                return Ok(args[0]);
            }
            let self_obj = args[0];
            ...
            if let Ok(data) = crate::baseobjspace::py_getattr(self_obj, "__data__") {
    ...
    let _ = crate::baseobjspace::py_setattr(
        obj,
        "__or__",
        crate::w_builtin_func_new("__or__", |args| {
            if args.len() < 2 {
                return Ok(args[0]);
            }
            let self_obj = args[0];
...
fn builtin_next(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    match crate::baseobjspace::py_next(args[0]) {
        Ok(v) => Ok(v),
    ...
    let is_callable = unsafe {
        crate::is_func(obj)
            ...
            || (pyre_object::is_instance(obj)
                && crate::baseobjspace::lookup_in_type_mro_pub(
...
fn builtin_vars(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    let dict = crate::baseobjspace::py_getattr(obj, "__dict__")
...
fn builtin_hash(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    unsafe {
        if pyre_object::is_instance(args[0]) {
            ...
            if let Some(method) = crate::baseobjspace::lookup_in_type_mro_pub(w_type, "__hash__") {
    ...
    for &arg in args {
        ...
        unsafe {
            if pyre_object::is_list(arg) {
                ...
                let it = crate::baseobjspace::py_iter(arg)?;
                loop {
                    match crate::baseobjspace::py_next(it) {
                        Ok(v) => items.push(v),
                        Err(e) if e.kind == crate::PyErrorKind::StopIteration => break,
...
fn builtin_reversed(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    unsafe {
        ...
        if pyre_object::is_instance(obj) {
            let w_type = pyre_object::w_instance_get_type(obj);
            if let Some(method) =
                crate::baseobjspace::lookup_in_type_mro_pub(w_type, "__reversed__")
            {
                return Ok(crate::space_call_function(method, &[obj]));
            }
        }
...
fn builtin_any(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    let items = collect_iterable_pub(args[0])?;
    for item in items {
        if crate::baseobjspace::py_is_true(item) {
            return Ok(w_bool_from(true));
        }
    }
...
fn builtin_sum(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    unsafe {
        if is_list(iterable) {
            ...
            for i in 0..n {
                if let Some(item) = w_list_getitem(iterable, i as i64) {
                    acc = crate::baseobjspace::py_add(acc, item).expect("sum: unsupported type");
                }
            }
            return Ok(acc);
        }
...
fn builtin_pow(args: &[PyObjectRef]) -> Result<PyObjectRef, crate::PyError> {
    ...
    crate::baseobjspace::py_pow(args[0], args[1])
}
