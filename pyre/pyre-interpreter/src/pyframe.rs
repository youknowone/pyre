...
impl PyFrame {
    ...
    fn finish_for_call_with_globals_obj(
        ...
        frame.init_cells();
        // The globals store and the scope binding allocate, and a collection
        // forwards the pin slot, not the field of this unboxed frame.
        frame.locals_cells_stack_w = _roots.get(locals_idx) as *mut FixedObjectArray;
        frame
    }
