...
mod residual_host {
    ...
    fn direct_uniform_i64_call(func_ptr: usize, args: &[i64]) -> Option<i64> {
        ...
        uniform_i64_allow_list![
            ...
            [value] => pyre_interpreter::opcode_ops::jit_baseobjspace_is_true,
            [obj, key] => pyre_interpreter::opcode_ops::jit_baseobjspace_delitem,
            [obj, name] => pyre_interpreter::opcode_ops::jit_baseobjspace_delattr,
            [obj, name, value] => pyre_interpreter::opcode_ops::jit_baseobjspace_setattr,
