...
spec_folds! {
    ...
    TruthInt             => ("truth_int",                "residual_call,inline_call", "-"),
    TruthBool            => ("truth_bool",               "residual_call,inline_call", "-"),
    ...
    FormatSimple         => ("format_simple",            "residual_call,inline_call", "-"),
    FormatWithSpec       => ("format_with_spec",         "residual_call,inline_call", "-"),
    ...
    StoreAttrDirect      => ("store_attr_direct",        "residual_call,inline_call", "-"),
    StoreAttrResidual    => ("store_attr_residual",      "residual_call,inline_call", "store_attr_direct"),
    LoadAttr             => ("load_attr",                "residual_call,inline_call", "-"),
    ...
    CompareOpInt         => ("compare_op_int",           "residual_call,inline_call", "-"),
    CompareOpLongInt     => ("compare_op_long_int",      "residual_call,inline_call", "-"),
