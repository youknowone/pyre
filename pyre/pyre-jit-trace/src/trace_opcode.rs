...
// `impl SharedOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl LocalOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl NamespaceOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl StackOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl IterOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl TruthOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl ControlFlowOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl BranchOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl ArithmeticOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).

// `impl ConstantOpcodeHandler for MIFrame` is auto-generated by majit-codewriter
// (see majit/majit-codewriter/src/codegen.rs::generate_trait_impls).
