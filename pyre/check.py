...
def main():
    ...
    if not args.synthetic_only:
        ...
        chk.run_bench("fib_recursive",  f"{B}/fib_recursive.py",        5,       1.5,     10,      2,       10)
        chk.run_bench("nested_loop",    f"{B}/nested_loop.py",          5,       None,    1.5,     None,    2)
        chk.run_bench("raise_catch",    f"{B}/raise_catch_loop.py",     5,       None,    None,    None,    None)
        chk.run_bench("spectral_norm",  f"{B}/spectral_norm.py",        5,       2,       5,       2,       5)
        chk.run_bench("nbody",          f"{B}/nbody_50k.py",           10,       5,       None,    5,       None)
        chk.run_bench("fannkuch",       f"{B}/fannkuch.py",            30,       1,       10,      2,       None)
