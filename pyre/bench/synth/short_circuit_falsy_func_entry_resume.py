...
# `_opimpl_recursive_call` looks inside on those bridges until
# `max_unroll_recursion` (`pyjitpl.py`); ubuntu-24.04 run 34810630624
# measured 5.9x against dynasm, so 6.8x is that reading plus
