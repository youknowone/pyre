...
# ubuntu-24.04 (PR 1738) measured 4.3x; the 5.0x allowance was that plus
# WASM_RATIO_FIT_HEADROOM. Three later ubuntu-24.04 runs (35491772991,
# 35547723188, 35592344587) read 1.9x, 2.1x, 2.3x, inside the 4.0 default.
