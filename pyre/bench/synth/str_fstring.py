...
# pyre-check: trace-shape=fstring_simple__main:absent=CallMayForceR,convert_value__main:absent=CallMayForceR,fstring_spec__main:present=Copystrcontent,string_ops__main:absent=CallMayForceR
