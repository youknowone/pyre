# pyre-check: max-pypy-ratio=121
# pyre-check: min-pypy-ratio=9
# pypy's exec time is a real measurement here, but the ratio still spans 18.6x
# to 70.3x across hosts, so the ceiling keeps 1.7x headroom over the slowest.
# The floor is explicit because the default ceiling/5 = 24.2 rejects the
# fastest host at 13.5x.
