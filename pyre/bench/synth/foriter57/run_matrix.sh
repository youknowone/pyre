...
PYRE="$1"
DIR="$(dirname "$0")"
for f in for_min for_sum for_sum_big for_raise for_gen for_user for_enumerate for_dictkeys for_user_raise for_hotraise for_mutate for_monkeypatch for_dict_abort for_iadd_list_abort for_iadd_bytearray_abort for_attr_abort for_deref_abort for_prop_abort for_prop_raise_abort for_nested for_nested_kept; do
