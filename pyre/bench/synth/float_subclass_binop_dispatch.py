...
# materializations and 314ms of trace compilation on darwin-arm64.  That
# topology once needed a 5.6x allowance, fitted to darwin-arm64 readings of
# 4.4x and 4.8x.  It reads 2.4x and 2.8x there now and 2.0x / 2.1x on
# ubuntu-24.04, so the fixture is back under WASM_MAX_DYNASM_RATIO and the
# allowance is gone.
#
