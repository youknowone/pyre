...
# Ubuntu run 34705838874: wasm/dynasm 4.7x. The oracle compiles 2 loops / 2
# bridges; pyre matches. wasm materializes each as its own module. 5.5x is
# 4.7x plus WASM_RATIO_FIT_HEADROOM (15%).
