...
# Ubuntu run 34705838874: wasm/dynasm 4.3x. The oracle compiles 1 loop / 11
# bridges; pyre matches. wasm materializes each as its own module. 5.0x is
# 4.3x plus WASM_RATIO_FIT_HEADROOM (15%).
