...
# def_op('BINARY_SLICE', 39)
# def_op('STORE_SLICE', 40)
...
jabs_op('JUMP_IF_NOT_EXC_MATCH', 113)
...
jabs_op('JUMP_ABSOLUTE', 153)        # ""
jrel_op('POP_JUMP_FORWARD_IF_NONE', 154)

def_op('FORMAT_VALUE', 155)
def_op('BUILD_CONST_KEY_MAP', 156)
def_op('BUILD_STRING', 157)

jrel_op('POP_JUMP_FORWARD_IF_NOT_NONE', 158)
def_op('GET_AWAITABLE', 159)
...
def_op('CALL_FUNCTION_KW', 170)  # #args + #kwargs
# def_op('CALL', 171)
# def_op('KW_NAMES', 172)
# hasconst.append(172)
...
pseudo_op('LOAD_METHOD_pseudo', 262, ['LOAD_ATTR'])    # PyPy: fix
