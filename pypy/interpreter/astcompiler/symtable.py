...
class ComprehensionScope(FunctionScope):
    """Scope for a list/set/dict comprehension or generator expression.

    Non-generator comprehensions are inlined into their parent (PEP 709);
    ``comp_inlined`` is set during finalize() when that happens.
    """
    comp_inlined = False
